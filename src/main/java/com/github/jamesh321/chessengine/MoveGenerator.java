...
public class MoveGenerator {
    ...
    private static ArrayList<Move> generateWhiteSinglePawnPushMoves(long pawns, long emptyNoPromotion) {
        ArrayList<Move> moveList = new ArrayList<>();
        long singlePushMoves = (pawns << 8) & emptyNoPromotion;
        moveList.addAll(getMoveList(singlePushMoves, 8, Move.NORMAL));
        return moveList;
    }

    private static ArrayList<Move> generateWhiteDoublePawnPushMoves(long pawns, long emptyNoPromotion) {
        ArrayList<Move> moveList = new ArrayList<>();
        long bothSquaresFree = (emptyNoPromotion >>> 16) & (emptyNoPromotion >>> 24) & 0b11111111;
        long doublePushMoves = (pawns << 16) & (bothSquaresFree << 24);
        moveList.addAll(getMoveList(doublePushMoves, 16, Move.NORMAL));
        return moveList;
    }
    ...
    private static ArrayList<Move> generateWhitePawnCaptureMoves(long pawns, long emptyNoPromotion,
        ...
        moveList.addAll(getMoveList(leftCaptureMoves, 9, Move.NORMAL));
        moveList.addAll(getMoveList(rightCaptureMoves, 7, Move.NORMAL));
        return moveList;
    }
    ...
    private static ArrayList<Move> generateWhitePawnEnPassantMoves(long pawns, long emptyNoPromotion,
        ...
        moveList.addAll(getMoveList(leftEnPassantMoves, 9, Move.EN_PASSANT));
        moveList.addAll(getMoveList(rightEnPassantMoves, 7, Move.EN_PASSANT));
        return moveList;
    }
    ...
    private static ArrayList<Move> generateWhitePawnPromotionMoves(long pawns, long emptyPromotion,
        ...
        for (int i = 0; i < 4; i++) {
            moveList.addAll(getMoveList(singlePushMoves, 8, 1 + (4 * i)));
            moveList.addAll(getMoveList(leftCaptureMoves, 9, 1 + (4 * i)));
            moveList.addAll(getMoveList(rightCaptureMoves, 7, 1 + (4 * i)));
        }
        return moveList;
    }

    private static ArrayList<Move> generateBlackSinglePawnPushMoves(long pawns, long emptyNoPromotion) {
        ArrayList<Move> moveList = new ArrayList<>();
        long singlePushMoves = (pawns >>> 8) & emptyNoPromotion;
        moveList.addAll(getMoveList(singlePushMoves, -8, Move.NORMAL));
        return moveList;
    ...
    private static ArrayList<Move> generateBlackDoublePawnPushMoves(long pawns, long emptyNoPromotion) {
        ArrayList<Move> moveList = new ArrayList<>();
    ...
    private static ArrayList<Move> generateBlackPawnCaptureMoves(long pawns, long emptyNoPromotion,
        ...
        moveList.addAll(getMoveList(leftCaptureMoves, -7, Move.NORMAL));
        moveList.addAll(getMoveList(rightCaptureMoves, -9, Move.NORMAL));
        return moveList;
    }
    ...
    private static ArrayList<Move> generateBlackPawnEnPassantMoves(long pawns, long emptyNoPromotion,
        ...
        moveList.addAll(getMoveList(leftEnPassantMoves, -7, Move.EN_PASSANT));
        moveList.addAll(getMoveList(rightEnPassantMoves, -9, Move.EN_PASSANT));
        return moveList;
    }
    ...
    private static ArrayList<Move> generateBlackPawnPromotionMoves(long pawns, long emptyPromotion,
        ...
        for (int i = 0; i < 4; i++) {
            moveList.addAll(getMoveList(singlePushMoves, -8, 1 + (4 * i)));
            moveList.addAll(getMoveList(leftCaptureMoves, -7, 1 + (4 * i)));
            moveList.addAll(getMoveList(rightCaptureMoves, -9, 1 + (4 * i)));
        }
        return moveList;
    }

    private static ArrayList<Move> getMoveList(long moves, int shift, int flag) {
        ArrayList<Move> moveList = new ArrayList<>();
        while (moves != 0) {
