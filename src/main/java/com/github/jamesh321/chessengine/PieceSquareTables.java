 ...
 * <p>
 * PSTs are used to evaluate the positional value of pieces based on their location on the board.
 * Each square on the board is assigned a value for each type of piece. A higher value means the square is more
 * advantageous for that piece.
 * <p>
 * The tables are defined from White's perspective. The tables for Black pieces are the reverse of the White tables.
 * The indices of the array correspond to squares on the board, from square 0 (A8) to 63 (H1).
 */
